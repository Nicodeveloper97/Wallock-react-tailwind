  ...
  return (
    <>
      <section
            ...
            id="Hablemos"
      >
      <section className="w-full h-auto bg-[#F2F2F7] py-8" id="Hablemos">
        <div className="w-4/5 h-auto rounded-lg bg-[#F2F2F7] px-8 pt-6 pb-8 mx-auto">
          ...
          <form action="" id="Hablemos">
            ...
            <div className="mt-6" id="Hablemos">
      ...
      <section className="bg-[#F2F2F7] w-full pt-12 pb-8" id="Hablemos">
      ...
      <footer className="w-full h-20 grid grid-rows text-white bg-black">
        <h2 
          className="text-slate-800 text-left m-auto">&copy; 
