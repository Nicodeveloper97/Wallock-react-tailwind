  ...
  return (
    <>
      <section className="bg-[#F2F2F7] pt-12 pb-8 mb-0" id="Nosotros">
        ...
        <h1 className="w-5/6 font-quicksand text-center text-sm mb-8 mx-auto text-gray-700 px-16 max-sm:px-4 sm:text-xl leading-9 tracking-widest">
      ...
      <section className="w-full h-auto bg-[#F2F2F7] space-y-6 pb-20" id="Nosotros">
        <h3 className="font-quicksand text-indigo-800 text-center font-semibold text-xl py-2">
      ...
      <section className="w-full bg-[#F2F2F7] pt-12 pb-20 pl-8" id="Nosotros">
        <div className="">
